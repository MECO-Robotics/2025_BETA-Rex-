...
public class DriveMotorConstants {
    ...
    public static final DriveMotorGains DRIVE_GAINS = new DriveMotorGains(0.05, 0, 0, 0.15, 0.06, 0, 0);

    public static final DriveMotorGains DRIVE_GAINS_SIM = new DriveMotorGains(2, 0, 0, 0.15, 0.65, 0, 0);
}
